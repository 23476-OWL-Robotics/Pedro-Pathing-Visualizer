...
public class Path {
    ...
    public void setLinearHeadingInterpolation(double startHeading, double endHeading) {
        ...
        this.interpolation = Interpolation.LINEAR_HEADING_INTERPOLATION;
    }
    ...
    public void setConstantHeadingInterpolation(double setHeading) {
        startHeading = 0;
        endHeading = 0;
        constantHeading = setHeading;
        isReversed = false;
        this.headingInterpolator = HeadingInterpolator.constant(setHeading);
        this.interpolation = Interpolation.CONSTANT_HEADING_INTERPOLATION;
    }
    ...
    public void setTangentHeadingInterpolation() {
        ...
        this.interpolation = Interpolation.TANGENTIAL_HEADING_INTERPOLATION;
    }
    ...
    public double[][] getDashboardDrawingPoints() {
        return this.curve.getPanelsDrawingPoints();
    }
