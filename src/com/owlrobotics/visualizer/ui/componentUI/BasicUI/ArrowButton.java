...
public class ArrowButton extends JButton implements SwingConstants
{
    ...
    public ArrowButton(int direction) {
        ...
        setBackground(Theme.scrollPanelTrackColor);
        this.shadow = Theme.scrollPanelTrackColor;
        this.darkShadow = Theme.scrollPanelTrackColor;
        this.highlight = Theme.scrollPanelTrackColor;
    }
                                       ...
                                       int direction, boolean isEnabled)
    {
        ...
        if (isPressed) g.setColor(Theme.scrollPanelButtonPressedColor);
                else g.setColor(Theme.scrollPanelButtonUnpressedColor);
    ...
    private void paintScaledTriangle(Graphics g, double x, double y, double size,
        ...
        if (!isEnabled) {
            g2d.translate(1, 0);
            g2d.setColor(Theme.scrollPanelButtonUnpressedColor);
            g2d.fill(path);
            g2d.translate(-1, 0);
        }
        g2d.setColor(isEnabled ? Theme.scrollPanelButtonPressedColor : Theme.scrollPanelButtonUnpressedColor);
        g2d.fill(path);
        g2d.translate(-tx, -ty);
