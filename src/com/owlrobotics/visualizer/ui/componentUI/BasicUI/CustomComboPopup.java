...
public class CustomComboPopup extends JPopupMenu implements ComboPopup {
...
//        comboBox.unregisterKeyboardAction( KeyStroke.getKeyStroke( KeyEvent.VK_ENTER, 0 ) );
    ...
    protected void configureList() {
        ...
        list.setBackground( Theme.editableTextBackgroundColor );
        list.setSelectionForeground(Theme.textColor);
        list.setSelectionBackground(Theme.textBoxBorderColor);
        list.setBorder( null );
