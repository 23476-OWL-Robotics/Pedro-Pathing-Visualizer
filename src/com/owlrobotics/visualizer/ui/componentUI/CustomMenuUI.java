 ...
 * @author Arnaud Weber
 */
public class CustomMenuUI extends CustomMenuItemUI
{
    /**
    ...
    static void loadActionMap(LazyActionMap map) {
        CustomMenuItemUI.loadActionMap(map);
    ...
    void installLazyActionMap() {
        LazyActionMap.installLazyActionMap(menuItem, CustomMenuUI.class,
    ...
    CustomMenuItemUI.Handler getHandler() {
        if (handler == null) {
            handler = new Handler();
        }
        return handler;
    ...
    public class ChangeHandler implements ChangeListener {
         ...
         */
        public ChangeHandler(JMenu m, CustomMenuUI ui) {
            menu = m;
            this.ui = ui;
        }
    ...
    private class Handler extends CustomMenuItemUI.Handler implements MenuKeyListener {
        //
