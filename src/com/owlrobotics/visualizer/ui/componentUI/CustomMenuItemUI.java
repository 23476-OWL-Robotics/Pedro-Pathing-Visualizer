...
import com.owlrobotics.visualizer.ui.componentUI.BasicUI.MenuItemCheckIconFactory;
 ...
 */
public class CustomMenuItemUI extends MenuItemUI
{
    /**
    ...
    protected void installDefaults() {
        ...
        if (selectionBackground == null ||
            ...
            selectionBackground = Theme.menuSelectedBackgroundColor;
        }
        if (selectionForeground == null ||
                selectionForeground instanceof UIResource) {
            selectionForeground = Theme.textColor;
        }
    ...
    void installLazyActionMap() {
        LazyActionMap.installLazyActionMap(menuItem, CustomMenuItemUI.class,
