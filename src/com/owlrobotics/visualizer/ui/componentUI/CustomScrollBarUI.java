...
import com.owlrobotics.visualizer.ui.componentUI.BasicUI.ArrowButton;
...
import com.owlrobotics.visualizer.ui.componentUI.BasicUI.UIAction;
        ...
        extends ScrollBarUI implements LayoutManager, SwingConstants
{
    ...
    private static final int MIN_SCROLL = 5;
    ...
    protected void configureScrollBarColors()
    {
        ...
        thumbHighlightColor = Theme.scrollPanelThumbColor;
        thumbLightShadowColor = Theme.scrollPanelThumbColor;
        thumbDarkShadowColor = Theme.scrollPanelThumbColor;
        thumbColor = Theme.scrollPanelThumbColor;
        trackColor = Theme.scrollPanelTrackColor;
        trackHighlightColor = Theme.sliderTrackColor;
    }
    ...
    protected void installKeyboardActions(){
        LazyActionMap.installLazyActionMap(scrollbar, javax.swing.plaf.basic.BasicScrollBarUI.class,
                "ScrollBar.actionMap");
    ...
    protected void paintThumb(Graphics g, JComponent c, Rectangle thumbBounds)
    {
        ...
        g.fillRect(3, (w - 6) / 2, w - 6, h - 7 - ((w - 6) / 2));

        g.fillOval(3, 0, w - 6, w - 6);
        g.fillOval(3, h - w + 5, w - 6, w - 6);
    ...
    private void updateButtonDirections() {
        ...
        if (scrollbar.getComponentOrientation().isLeftToRight()) {
            if (incrButton instanceof ArrowButton) {
                ((ArrowButton)incrButton).setDirection(
                        orient == HORIZONTAL? EAST : SOUTH);
            }
            if (decrButton instanceof ArrowButton) {
                ((ArrowButton)decrButton).setDirection(
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed(ActionEvent e) {
            ...
            if (key == POSITIVE_UNIT_INCREMENT) {
                ...
                scroll(scrollBar, CustomScrollBarUI.MIN_SCROLL, true);
            }
            else if (key == MAX_SCROLL) {
                scroll(scrollBar, CustomScrollBarUI.MAX_SCROLL, true);
            }
        }
        private void scroll(JScrollBar scrollBar, int dir, boolean block) {
            ...
            else if (dir == CustomScrollBarUI.MIN_SCROLL) {
                scrollBar.setValue(scrollBar.getMinimum());
            }
            else if (dir == CustomScrollBarUI.MAX_SCROLL) {
