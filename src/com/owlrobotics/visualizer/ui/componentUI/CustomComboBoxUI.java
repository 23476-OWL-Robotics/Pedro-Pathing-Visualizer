...
import com.owlrobotics.visualizer.ui.componentUI.BasicUI.*;
...
public class CustomComboBoxUI extends ComboBoxUI {
    ...
    protected JButton createArrowButton() {
        JButton button = new ArrowButton(BasicArrowButton.SOUTH);
    ...
    public void paintCurrentValue(Graphics g,Rectangle bounds,boolean hasFocus) {
        ...
        if ( hasFocus && !isPopupVisible(comboBox) ) {
            ...
            c = renderer.getListCellRendererComponent( listBox,
                    ...
                    false,
                    false );
            c.setBackground(Theme.editableTextBackgroundColor);
        }
    ...
    public void paintCurrentValueBackground(Graphics g,Rectangle bounds,boolean hasFocus) {
        Color t = g.getColor();
        if ( comboBox.isEnabled() )
            g.setColor(Theme.editableTextBackgroundColor);
        else
            g.setColor(Theme.editableTextBackgroundColor);
    ...
    protected void installKeyboardActions() {
        ...
        LazyActionMap.installLazyActionMap(comboBox, CustomComboBoxUI.class,
                "ComboBox.actionMap");
    }
    ...
    private static class Actions extends UIAction {
        ...
        public void actionPerformed( ActionEvent e ) {
            ...
            CustomComboBoxUI ui = (CustomComboBoxUI) BasicLookAndFeel.getUIOfType(
                    comboBox.getUI(), CustomComboBoxUI.class);
            if (key == HIDE) {
        ...
        private int getNextIndex(JComboBox<?> comboBox, String key) {
            ...
            if (UIManager.getBoolean("ComboBox.noActionOnKeyNavigation")
                    && (comboBox.getUI() instanceof CustomComboBoxUI)) {
                selectedIndex = ((CustomComboBoxUI) comboBox.getUI()).listBox.getSelectedIndex();
            }
    ...
    private class Handler implements ActionListener, FocusListener,
        ...
        public void propertyChange(PropertyChangeEvent e) {
            ...
            if (e.getSource() == editor){
                ...
                else if ( propertyName == CustomComboBoxUI.IS_TABLE_CELL_EDITOR ) {
